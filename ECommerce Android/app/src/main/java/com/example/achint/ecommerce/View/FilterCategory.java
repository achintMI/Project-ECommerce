...
public class FilterCategory extends AppCompatActivity implements ProductAdapter.IAdapterCommunicator {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String productFilter = category.getString("filter");
        ...
        getAllProductsByFilter(productFilter);
    }

    public void getAllProductsByFilter(String productFilter) {
        Call<ProductData[]> call = null;
        if(productFilter.equals("price")){
            call = productApi.getProductSortByPrice();
        }else if(productFilter.equals("rating")){
            call = productApi.getProductSortByRating();
        }
        ...
        call.enqueue(new Callback<ProductData[]>() {
            ...
            public void onResponse(Call<ProductData[]> call, Response<ProductData[]> response) {
                if (200 == response.code()) {
                    ...
                    Toast.makeText(FilterCategory.this, "Worked", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ProductData[]> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(FilterCategory.this, "Failed to fetch", Toast.LENGTH_LONG).show();
            }
        });
    }
